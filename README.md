...
## 4. Dificuldades
Entre as dificuldades encontradas esta o carregamento do objeto para o software uma vez que o OpenGL não impleta isto e inicialmente foram feitas tentativas falhas com a biblioteca Assimp. Fez-se progresso nesta etapa através de um loader disponibilizado pelo professor. Além disto tivemos dificuldade encontrar os valores compatíveis para o fator de escala, o ângulo para a matriz de rotação e demais valores para os elementos das matrizes.
